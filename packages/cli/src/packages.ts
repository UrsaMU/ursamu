...
export const optionalPackages: PackageOption[] = [
  ...
  },
  {
    ...
    jsrUrl: "jsr:@ursamu/discord@^0.1.0",
  ...
  },
  {
    name: "In-Game Wiki",
    pkgName: "@ursamu/wiki",
    jsrUrl: "jsr:@ursamu/wiki@^0.1.0",
    description: "Wiki system, editing, & backlinks",
  },
  {
    name: "Jobs System",
    pkgName: "@ursamu/jobs",
    jsrUrl: "jsr:@ursamu/jobs@^0.1.0",
  ...
  },
  {
    ...
    jsrUrl: "jsr:@ursamu/map-plugin@^3.0.0",
  ...
  },
  {
    ...
    jsrUrl: "jsr:@ursamu/channels@^0.1.0",
