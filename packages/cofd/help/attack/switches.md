...
SEE ALSO: help attack (overview).
  ...
  /allout         +2 pool; lose all Defense this turn.
  ...
  /offhand        -2 pool for non-dominant hand.
  /pull <n>       Pull blow: damage cap n. Target gains +1 Def.
  /wp             Spend 1 Willpower for +3 dice.
  /head /arm /leg /hand /eye /heart /torso
                  Specified body part. +attack Goon/head | /head Goon
  /touch          Dex+Brawl or Dex+Weaponry contact; no damage.

SEE ALSO: help attack/defense, help attack/damage
