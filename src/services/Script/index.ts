// Bridge: script registry lives in @ursamu/mush
export { registerScript, getScript } from "@ursamu/mush";

// QuickJS sandbox runner — used in tests and legacy script execution
...
export class ScriptService {
  ...
  async run(code: string, ctx: IContext) {
    ...
    runtime.setInterruptHandler(() => {
      const timedOut = Date.now() - start > 50;
